...
UserBYNotClass.prototype.UpperName = function () {
  return `Username is ${this.username.toUpperCase()}`;
};
UserBYNotClass.prototype.encryptPassword = function () {
  return `passwords is ${this.password}abc`;
};

let userX = new UserBYNotClass("shyan", "S1132", 8745);
console.log(userX.UpperName());
console.log(userX.encryptPassword());
